...
// children의 타입 : ReactNode란걸 이용하는데, 특징으로 JSX, 문자열, 배열 등 모드 허용한다.
...
export function useAuth() : AuthContextType {
  ...
  // null 이면 AuthProvider return 외부에서 사용했다는 의미가 된다. -> 오류가 발생해야함
  if (!context) {
    throw new Error ('useAuth는 AuthProvider 내부에서만 사용할 수 있습니다.');
  }
  // 정상 작동 한다면 TypeScript의 return 타입에 따라서 작성해야 하기 때문에
  return context;
}